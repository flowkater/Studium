...
//		  
	...
	private AlertDialog createDialog() {
		...
		Button camera = (Button) innerView
				.findViewById(R.id.btn_camera_crop);
		Button gellary = (Button) innerView
				.findViewById(R.id.btn_gellary_crop);
		...
		AlertDialog.Builder ab = new AlertDialog.Builder(
				PostPageActivity.this);
		ab.setTitle("업로드 할 이미지 선택");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case PICK_FROM_ALBUM: 
		{
					if (data.getData() != null) {
						...
						image[current_position] = BitmapFactory
								.decodeFile(image_url);
				}
