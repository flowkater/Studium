...
public class GroupIndexActivity extends SlidingFragmentActivity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTabsAdapter.addTab(bar.newTab().setCustomView(tv).setText("모집메시지"), PartyMessagesFragment.class, null);
		mTabsAdapter.addTab(bar.newTab().setCustomView(tv2).setText("그룹"), GroupListFragment.class, null);
